  ...
  return (
    ...
    >
      <Modal.Body>
                    ...
                    {state.measurSpec.length ? (
                      state.measurSpec?.map((spec, i) => (
                        <tr key={i} className="text-center">
                          ...
                          <td>{spec.POM_PLUS}</td>
                          <td>{spec.POM_MIN}</td>
                          <td>{findOutputMes(dataPostMes, spec.POM_ID, 1)}</td>
                          <td>{findOutputMes(dataPostMes, spec.POM_ID, 2)}</td>
                          <td>{findOutputMes(dataPostMes, spec.POM_ID, 3)}</td>
                          <td>{findOutputMes(dataPostMes, spec.POM_ID, 4)}</td>
                          <td>{findOutputMes(dataPostMes, spec.POM_ID, 5)}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
        ...
        <div id="mdlInpt" className="bg-maeasur-inpt">
          <div id="contentMdl" className="mdl-input-measure">
            <Row className="justify-content-center">
              <Col sm={1} className="text-center bg-primary rounded py-1">
                <h4 className="text-light mb-0">#{seq}</h4>
              </Col>
            </Row>
            <Row style={{ height: "18vh" }} className="pt-1">
              <Col sm={1}>
                <Button
                  className="mt-4"
                  variant="light"
            ...
            <Row className="justify-content-end mt-3 pe-5">
              <Col sm={3} className="text-end ">
                <Button
                  className="me-2"
                  size="sm"
